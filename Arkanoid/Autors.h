...
namespace Arkanoid {
	...
	/// Summary for Autors
	/// </summary>
	public ref class Autors : public System::Windows::Forms::Form
	{
	public:
		Autors(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Location = System::Drawing::Point(75, 51);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(160, 57);
			this->textBox1->TabIndex = 0;
			this->textBox1->Text = L"Grê stworzyli:\r\nArtur Mazela\r\nMateusz Nowak";
			this->textBox1->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &Autors::TextBox1_TextChanged);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(93, 140);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(124, 32);
			this->button1->TabIndex = 1;
			this->button1->Text = L"OK";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Autors::Button1_Click);
			// 
			// Autors
			// 
